...
<body>
	...
	<div style = "margin-left:0;" class = "container">
		<div class = "panel panel-default">
			<div class = "panel-body">
				<strong><h3>Our Collections</h3><small><p>Welcome To Our Home , The Home Of Flowers</p></small></strong>
				<br />
				<br />
				...
				<br />
				<div style = "float:left; width:250px; height:250px; margin-left:20px;">
					<img src = "images/gallery/red.jpg" width = "250" height = "250"/>
				</div>
				<div style = "float:left; width:250px; height:250px; margin-left:20px;">
					<img src = "images/gallery/peach.jpg" width = "250" height = "250"/>
				</div>
	...
	<div style = "text-align:right; margin-right:10px;" class = "navbar navbar-default navbar-fixed-bottom">
		<label>Saad Daheleb University</label>
	</div>
</body>
